...
main = tkinter.Tk()
main.title("object detection system using ML") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Object Detection system using Python', justify=LEFT)
...
font1 = ('times', 14, 'bold')
model = Button(main, text="Generate  Train & Test Model", command=generateModel)
